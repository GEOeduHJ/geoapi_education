...
export const DATASET_CATALOG: DatasetDefinition[] = [
  ...
  },
  {
    ...
    topic: "인구·도시화",
    space: "국가",
    coverage: "200개국 이상·2018~2024",
    period: { min: "2018", max: "2024", label: "2018~2024" },
    capabilities: ["map", "chart", "table"],
    status: "ready",
    description: "국가별 인구밀도를 공개 snapshot의 세계 단계구분도·순위 그래프·자료표로 표시합니다.",
  ...
  },
  {
    ...
    topic: "기후·계절성",
    space: "도시 좌표",
    coverage: "5개 도시·2024년 일자료",
    period: { min: "2024", max: "2024", label: "2024" },
    capabilities: ["map", "table"],
    status: "ready",
    description: "5개 세계 도시의 일평균기온·일강수량을 점분포와 목록으로 비교합니다. 재분석 자료이며 관측소 공식값과 구분합니다.",
  ...
  },
  {
    ...
    topic: "자연재해·판 구조",
    space: "지진 발생점",
    coverage: "M6.0 이상·2020~2026",
    period: { min: "2020", max: "2026", label: "2020~2026" },
    capabilities: ["map", "table"],
    status: "ready",
    description: "규모 6.0 이상 지진의 위치·규모·깊이·발생 시각을 점분포와 목록으로 탐구합니다. 안전 알림이 아니라 과거 기록입니다.",
  ...
  {
    key: "gbif-flagship-species",
    scope: "domestic",
    title: "상징종 분포",
    provider: "GBIF",
    topic: "생태·보전",
    space: "발생지점",
    coverage: "두루미·저어새 1,257행",
    period: { min: "2015", max: "2026", label: "2015~2026" },
    capabilities: ["map", "table"],
    status: "ready",
    description: "두루미·저어새의 국내 발생 기록을 점분포와 목록으로 표시합니다. 레코드별 라이선스·제공자를 함께 기록합니다.",
  ...
  {
    key: "opentopo-seoul-busan-profile",
    scope: "domestic",
    title: "서울-부산 고도 횡단면",
    provider: "OpenTopoData",
    topic: "지형·고도",
    space: "횡단면 25지점",
    coverage: "서울→부산 직선 25지점",
    period: { min: "-", max: "-", label: "수집시점 기준" },
    capabilities: ["map", "table"],
    status: "ready",
    description: "서울→부산 직선 25지점의 SRTM 고도를 단면 그래프와 목록으로 표시합니다.",
