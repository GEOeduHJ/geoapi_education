...
export const USGS_SNAPSHOT_SCHEMA = "usgs-earthquake-v1";
export const OPENMETEO_SNAPSHOT_SCHEMA = "openmeteo-city-v1";
export const OPENTOPO_SNAPSHOT_SCHEMA = "opentopo-profile-v1";
export const GBIF_SNAPSHOT_SCHEMA = "gbif-occurrence-v1";
