...
- `/create`: 자료 제작 허브
- `/create/2d`: VWorld 2D 지도자료 작업공간, KMA ASOS 관측소 레이어, KOSIS 선택 시 SGIS 기준경계 레이어
